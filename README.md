...
| 厂商 | 模型 | 特点 | 发布时间 |
|------|------|------|----------|
| 字节 | Seedance 2.0 | 文本/图片/视频输入,镜头保持一致 | 2026年2月12日 |
| 快手 | 可灵 1.6 | AI视频生成 | 2026年 |
| 生数 | Vidu 2.0 | AI视频生成 | 2026年 |

### 语音合成

| 厂商 | 模型/服务 | 特点 |
|------|------------|------|
| 阿里云 | CosyVoice 2.0 | 开源,3秒复刻,支持方言/情绪 |
| 阿里云 | KAN-TTS | 神经网络+领域知识,多语种方言 |
| 百度 | TTS | 中文优势 |
| 讯飞 | TTS | 多语言支持 |
